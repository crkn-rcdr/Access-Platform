...
<div class="popup auto-align" bind:this={popupWrapper}>
	<div bind:this={popupButton} on:click={handlepopupButtonClick} class="dropbtn">
	...
	>
		...
		<div class="popup-actions">
			<button class="btn secondary sm" on:click={handleCancelPressed}>Cancel</button>
			<button class="btn primary sm" on:click={handleOkPressed}>Ok</button>
		</div>
	</div>
</div>
